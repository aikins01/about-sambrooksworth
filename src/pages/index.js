  ...
  return (
    ...
    >
      <h2 className="flex text-sm font-semibold text-zinc-900 dark:text-zinc-100">
        ...
        <span className="ml-3">Have a question for me?</span>
      </h2>
      <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
        Send me a message and I&apos;ll get back to you as soon as possible.
      </p>
      <div className="flex justify-end mt-6">
        <Button href={'/contact-me'} className="flex-none ">
          Let&apos;s talk
        </Button>
      </div>
    </form>
...
function Resume() {
  ...
  return (
    <div className="p-6 border rounded-2xl border-zinc-100 dark:border-zinc-700/40">
      ...
      <Button href="/my-work" variant="secondary" className="w-full mt-6 group">
        See more
        ...
        <div className="grid max-w-xl grid-cols-1 mx-auto gap-y-20 lg:max-w-none lg:grid-cols-2">
          <div className="flex flex-col gap-16">
            ...
            <div className="flex justify-center">
              <Link
                href="/articles"
                className="inline-flex items-center justify-center px-5 py-3 text-base font-medium border border-transparent rounded-md shadow-sm bg-zinc-100 text-zinc-800 hover:bg-zinc-200 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700"
              >
                See all
              </Link>
            </div>
